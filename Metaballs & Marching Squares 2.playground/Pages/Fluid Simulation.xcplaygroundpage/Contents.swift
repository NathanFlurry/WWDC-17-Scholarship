/*:
 ...
 One of the most common uses of metaballs in games are for simulating fluids, as seen in games like *Where's My Water* and *Sprinkle*. In this simulation, the SpriteKit physics engine is being used in conjunction with the metaballs engine to render a fluid-like path into a `SKShapeNode`.
 ...
 ---
 [◀ Example: Loading Indicators](@previous) • [Where To Go From Here ▶](@next)
 */
...
floor.lineWidth = 0
floor.fillColor = UIColor.corsilk
...
for i in 0..<4 {
    ...
    circle.lineWidth = 0
    circle.fillColor = UIColor.corsilk
...
for i in 0..<4 {
    ...
    square.lineWidth = 0
    square.fillColor = UIColor.corsilk
